...
public class ServletPrincipal extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher rd = request.getRequestDispatcher ("/Pantallas/template_inicio.jsp");
    ...
    public String getServletInfo() {
        return "ServletPrincipal: Servlet que atiende todas las peticiones de la aplicación f1Sopra.";
    }

    /**
     * Método que se encarga de construir la estrucutura de menú para enviarla a la página. La estructura consiste en un ArrayList de HashMap
     * donde cada HashMap es una opción de menú y contiene dos elementos, "texto" y "url".
     * @param consultaMenu
     * @param request
     * @throws SQLException
     */
